...
//          <h2 className="text-3xl">🧪 NDT Procedure Generator</h2>
   ...
   return (
      <>
         ...
         <div className="max-w-3xl mx-auto px-4 py-8">
            ...
            {/* Prompt Guide */}
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-5 mb-8 shadow-sm">
               <h3 className="text-lg font-semibold text-gray-700 mb-2 flex items-center gap-2">
                  <span role="img" aria-label="lightbulb">💡</span>
                  How to Write Effective Prompts
               </h3>
               <p className="text-sm text-gray-500 mb-2">
                  Be specific about what you need. Here are some examples:
               </p>
               <div className="text-sm text-gray-700">
                  <strong>Good Example:</strong>
                  <ul className="list-disc ml-6 mt-2 space-y-1">
                     <li>
                        Generate a detailed NDT procedure based on the following inputs:
                     </li>
                     <li>
                        <strong>Method:</strong> [e.g., Magnetic Particle Testing (MPT) using AC/DC Yoke]
                     </li>
                     <li>
                        <strong>Equipment:</strong> [e.g., Magnaflux Yoke, Model XYZ]
                     </li>
                     <li>
                        <strong>Power Source:</strong> [e.g., 230V AC or 12V DC]
                     </li>
                     <li>
                        <strong>Application:</strong> [e.g., Structural weld inspection]
                     </li>
                     <li>
                        <strong>Standards/Acceptance Criteria:</strong> [e.g., API 1104]
                     </li>
                     <li>
                        <strong>Consumables:</strong> [e.g., Magnaflux brand particles and cleaner]
                     </li>
                     <li>
                        <strong>Comments:</strong>
                     </li>
            ...
            <textarea
               ...
               value={userInput}
               onChange={(e) => setUserInput(e.target.value)}
               className="w-full p-3 text-base mb-4 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#004aad] resize-y min-h-[80px]"
            />

            <button
               onClick={handleGenerateProcedure}
               disabled={loading || !userInput.trim()}
               className={`bg-[#004aad] hover:bg-[#004aad] text-white font-semibold py-2 px-6 rounded-md transition-colors duration-150 ${loading || !userInput.trim() ? "opacity-50 cursor-not-allowed" : ""}`}
            >
               {loading ? "Generating..." : "Generate"}
            </button>
            ...
            <div className="mt-8">
               <JoditEditor
                  className="w-full bg-yellow-100 rounded-md border border-yellow-300"
                  ref={editor}
                  value={content}
                  config={config}
                  tabIndex={1}
