                           ...
                           <div className="grid grid-cols-2 gap-4">
                              ...
                              <div>
                                 ...
                                 <Select
                                    ...
                                    disabled={!!quotationForm.currency}
                                 >
                                    <SelectTrigger>
                                       <SelectValue />
                                    </SelectTrigger>
                     ...
                     <div className="p-6">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                           ...
                           <div className="space-y-6">
                              ...
                              {/* Negotiation History */}
                              {selectedQuotation.negotiations &&
                                 selectedQuotation.negotiations.length > 0 && (
                                    <Card>
                                       <CardHeader>
                                                ...
                                                onClick={() => {
                                                   setNegotiationForm(
                                                      (prev) => ({
                                                         ...prev,
                                                         message:
                                                            "I accept your proposed terms and amount. Let's proceed with this agreement.",
                                                      })
                                                   );
                                                }}
                                             >
                                                ...
                                                onClick={() => {
                                                   setNegotiationForm(
                                                      (prev) => ({
                                                         ...prev,
                                                         message:
                                                            "I understand your position, but I need to maintain my original quote due to project requirements and costs.",
                                                      })
                                                   );
                                                }}
                                             >
