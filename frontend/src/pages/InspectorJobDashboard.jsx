...
const InspectorJobDashboard = () => {
   ...
   const fetchJobs = useCallback(async () => {
      try {
         ...
         if (filters.urgency && filters.urgency !== "all")
            params.urgencyLevel = filters.urgency;
   ...
   const filteredJobs = jobs.filter((job) => {
      ...
      const matchesUrgency =
         !filters.urgency ||
         filters.urgency === "all" ||
         job.urgencyLevel === filters.urgency;
      const matchesSearch =
         !filters.search ||
               ...
               <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  <div>
                     <h1 className="text-3xl font-bold text-[#004aad]">
                        Inspector Job Dashboard
                     </h1>
                     <p className="text-gray-600 mt-1">
                        Manage and track your assigned job requests
                     </p>
                  </div>
            ...
            {loading ? (
               ...
               <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
                  {filteredJobs.map((job) => {
                     const StatusIcon =
                        statusConfig[job.status]?.icon || FileText;
                     return (
                        <Card
                           key={job._id}
                           ...
                           <CardContent className="space-y-4">
                              ...
                              <div className="space-y-2 text-sm">
                                 ...
                                 <div className="flex items-center gap-2">
                                    ...
                                    <Badge
                                       className={
                                          urgencyConfig[job.urgencyLevel]?.color
                                       }
                                    >
                                 ...
                                 <Dialog>
                                    ...
                                    <DialogContent className="!max-w-4xl max-h-[90vh] overflow-y-auto">
                                       <DialogHeader>
                                          ...
                                          <DialogDescription>
                                             Complete information about job
                                             request #
            ...
            <Dialog open={noteDialogOpen} onOpenChange={setNoteDialogOpen}>
               <DialogContent>
                  <DialogHeader>
                     ...
                     <DialogDescription>
                        Add a Message to job: {selectedJob?.title}
                     </DialogDescription>
                  </DialogHeader>
                  <div className="space-y-4">
                     <div>
                        <Label htmlFor="noteType">Message Type</Label>
                     ...
                     <div>
                        <Label htmlFor="note">Message Content</Label>
                        <Textarea
                           id="note"
      ...
      <Tabs defaultValue="overview" className="w-full">
         ...
         <TabsContent value="overview" className="space-y-4">
            ...
            <div>
               ...
               {job.requiredServices && job.requiredServices.length > 0 ? (
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                     {job.requiredServices.map((service) => (
                        <Card
                           key={service._id}
                           className="border border-[#004aad]/20 hover:border-[#004aad]/40 transition-colors"
                        >
                           <CardContent className="pt-4">
                              <div className="flex items-center justify-between">
                                 <div className="flex-1">
                                    ...
                                    <Badge
                                       variant="outline"
                                       className="mt-1 text-[#004aad] border-[#004aad]"
                                    >
                                       {service.code}
                                    </Badge>
                                 </div>
                  ...
                  <div className="text-center py-6 text-gray-500">
                     ...
                     <p>No required services specified</p>
                  </div>
               )}
            </div>
         </TabsContent>
         ...
         <TabsContent value="actions" className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
               ...
               <Button
                  variant="outline"
                  className="h-20  flex-col gap-2 hidden"
               >
