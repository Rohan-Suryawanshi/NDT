...
const ServiceProviderFeedback = () => {
  ...
  const fetchFeedbacks = useCallback(async () => {
    try {
      ...
      const averageRating = totalFeedbacks > 0 
        ? jobsWithRatings.reduce((sum, job) => sum + job.clientRating.rating, 0) / totalFeedbacks        : 0;
  ...
  const filteredFeedbacks = jobRequests
    ...
    const jobTitle = job.title || 'Service Request';
    ...
    const matchesServiceType = filters.serviceType === 'all' || 
      job.requiredServices?.some(service => service.name?.includes(filters.serviceType));
    
    return matchesSearch && matchesRating && matchesServiceType;
  });
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
            ...
            <Card className="bg-gradient-to-r from-yellow-500 to-yellow-600 text-white">
              <CardContent className="pt-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-yellow-100 text-sm font-medium">Positive Reviews</p>
            ...
            <Card className="bg-gradient-to-r from-purple-500 to-purple-600 text-white">
              <CardContent className="pt-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-purple-100 text-sm font-medium">Recent (30d)</p>
            ...
            <Card className="bg-gradient-to-r from-indigo-500 to-indigo-600 text-white">
              <CardContent className="pt-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-indigo-100 text-sm font-medium">Repeat Clients</p>
                ...
                <CardHeader>
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                      ...
                      <CardDescription>Reviews and ratings from clients after service completion</CardDescription>
                    </div>
                    <div className="flex gap-2">
            ...
            <TabsContent value="jobs">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>All your completed service jobs and their feedback status</CardDescription>
                </CardHeader>
...
// Feedback List Component (adapted for service providers)
  ...
  if (feedbacks.length === 0) {
    return (
      <div className="text-center py-8 text-gray-500">
        ...
        <p className="text-sm mt-1">Client feedback will appear here after service completion</p>
      </div>
    );
  }

  return (
    <div className="space-y-4">      {feedbacks.map((job, index) => {
        const feedback = job.clientRating;
        const jobTitle = job.title || 'Service Request';
        const clientName = job.clientName || 'Unknown Client';
        ...
        return (
          <Card key={job._id || index} className="border-l-4 border-l-green-500">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-4 mb-3 text-sm text-gray-600">
                    ...
                    <span className="flex items-center gap-1">
                      ...
                      {job.requiredServices?.[0]?.name || 'Service'}
                    </span></div>
...
// Completed Jobs List Component (adapted for service providers)
  ...
  if (completedJobs.length === 0) {
    return (
      <div className="text-center py-8 text-gray-500">
        ...
        <p className="text-sm mt-1">Completed service jobs will appear here</p>
      </div>
    );
  }

  return (
    <div className="space-y-4">      {completedJobs.map((job, index) => {
            ...
            <CardContent className="pt-4">
              <div className="flex items-start justify-between mb-3">
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600 mt-1">{job.description || 'Service request'}</p>
              ...
              <div className="flex items-center justify-between">
                <div className="text-sm text-gray-600">
                  Status: <strong>Service Complete</strong>
                </div>
...
// Service Feedback Analytics Component
const ServiceFeedbackAnalytics = ({ feedbacks, stats }) => {
  ...
  feedbacks.forEach(job => {
    const serviceType = job.requiredServices?.[0]?.name || 'Other';
    if (!categoryPerformance[serviceType]) {
      categoryPerformance[serviceType] = { total: 0, sum: 0 };
    }
    categoryPerformance[serviceType].total++;
    categoryPerformance[serviceType].sum += job.clientRating.rating;
  });
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex justify-between">
            ...
            <span className="font-semibold text-purple-600">{stats.repeatClients}</span>
          </div>
          <div className="flex justify-between">
        ...
        <Card className="md:col-span-2">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {topCategories.map(({ category, average, count }) => (
                <div key={category} className="text-center p-4 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">{count} reviews</p>
                </div>
              ))}
            </div>
          </CardContent>
