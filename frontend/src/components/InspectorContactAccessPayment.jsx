...
import { CreditCard, Loader2, Shield, Check, Lock, Mail, Phone, User } from "lucide-react";
...
const InspectorContactAccessPayment = ({ inspector, onSuccess, onCancel }) => {
   ...
   const amount = locationData.chargeContactInspector;
   ...
   const handleSubmit = async (event) => {
      ...
      try {
         ...
         const { data } = await axios.post(
            `${BACKEND_URL}/api/v1/payments/create-inspector-contact-payment-intent`,
            {
               inspectorId: inspector.userId._id,
               inspectorName: inspector.fullName,
               amount: Math.round(amount * 100), // Convert to cents
               currency: currency,
               description: `Inspector contact access for ${inspector.fullName}`,
            },
            {
         ...
         if (error) {
            ...
            const confirmResponse = await axios.post(
               `${BACKEND_URL}/api/v1/payments/confirm-inspector-contact-payment`,
               {
            ...
            await axios.post(
               `${BACKEND_URL}/api/v1/contact/send-inspector-contact-email`,
               {
                  inspectorId: inspector.userId._id,
                  inspectorName: inspector.fullName,
                  inspectorEmail: inspector.userId.email,
               ...
               <div className="text-center space-y-4">
                  ...
                  <div>
                     ...
                     <p className="text-green-700 mt-1">
                        Contact details for inspector {inspector.fullName} have been revealed and sent to your email.
                     </p>
                  </div>
               </div>
            </CardContent>
         ...
         <Card>
            <CardHeader>
               <CardTitle className="text-lg flex items-center gap-2">
                  ...
                  Inspector Contact Access Purchase
               </CardTitle>
            </CardHeader>
         ...
         <Card>
            ...
            <CardContent className="space-y-2">
               <div className="flex justify-between text-sm">
                  <span>Inspector Contact Access Fee:</span>
               ...
               <div className="text-xs text-gray-500 mt-2">
                  * One-time payment for access to this inspector's contact details
               </div>
            </CardContent>
         </Card>
...
export default InspectorContactAccessPayment;
